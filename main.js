...
const newLink = (link) => {
  ...
  <a href="https://${link}" target="_blank" style="display:flex; align-items:center; gap: 0.3rem">
...
if(url[0] === 'github.com') {
  if(/.*.(github.io)/g.test(url[2]) && url[1].toLocaleLowerCase() === url[2].substring(0, url[2].length - 10))
  {
    newLink(url[2])
  } else {
